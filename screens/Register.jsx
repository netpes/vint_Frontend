...
export default function Login({ navigation }) {
  ...
  return (
    <ImageBackground source={skyBG} resizeMode='cover' className="flex h-screen justify-around items-center bg-sky-800">
      ...
      <View className='h-3/4 w-full justify-start items-center'>
        <View className='flex flex-row items-center justify-start h-14 px-3 w-3/4 bg-white/10 border-b-4 border-b-white rounded-lg mb-6'>
          <Entypo name="email" size={24} color="white" />
          <TextInput inputMode="text" placeholder="User Name" placeholderTextColor='white' className='h-full w-full ml-2 text-base text-white' />
        </View>
        <View className='flex flex-row items-center justify-start h-14 px-3 w-3/4 bg-white/10 border-b-4 border-b-white rounded-lg mb-6'>
          <Entypo name="email" size={24} color="white" />
        ...
        <View className='flex flex-row items-center justify-start h-14 px-3 w-3/4 bg-white/10 border-b-4 border-b-white rounded-lg mb-6'>
          <Entypo name="email" size={24} color="white" />
          <TextInput inputMode="tel" placeholder="Phone" placeholderTextColor='white' className='h-full w-full ml-2 text-base text-white' />
        </View>
        <View className='flex flex-row items-center justify-start h-14 px-3 w-3/4 bg-white/10 border-b-4 border-b-white rounded-lg mb-6'>
          <Entypo name="email" size={24} color="white" />
          <TextInput inputMode="text" placeholder="Password" placeholderTextColor='white' className='h-full w-full ml-2 text-base text-white' />
        </View>
        <View className='flex flex-row items-center justify-start h-14 px-3 w-3/4 bg-white/10 border-b-4 border-b-white rounded-lg mb-6'>
          <Entypo name="email" size={24} color="white" />
          <TextInput inputMode="text" placeholder="Confirm Password" placeholderTextColor='white' className='h-full w-full ml-2 text-base text-white' />
        </View>
        <TouchableOpacity className='mt-3'><Text className='text-white/60 '>Forgot Password?</Text></TouchableOpacity>
        <TouchableOpacity style={styles.logoShadow} className='mt-7 h-14 w-1/2 bg-white/70 rounded-2xl flex justify-center items-center'><Text>Lets Go</Text></TouchableOpacity>
